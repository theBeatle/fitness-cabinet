...
namespace FitnessApp.Controllers
{
    ...
    public class ExternalAuthController : Controller
    {
        ...
        public ExternalAuthController(IOptions<FacebookAuthSettings> fbAuthSettingsAccessor, UserManager<Person> userManager, ApplicationContext appDbContext, IJwtFactory jwtFactory, IOptions<JwtIssuerOptions> jwtOptions)
        {
